...
public interface UserFilesService {
	 ...
	 * already exists its previous size is not taken into account when creating the file.
	 */
	boolean canUserCreateFileWithSize(String username, String filename, long fileSize);

	/**
	 * @param filesToIgnore is a set of file names that are not considered when calculating the
	 *        size!
	 */
	...
	void shareFileWith(User fileOwner, String filename, String sharedWithUsername, boolean canEdit)
			throws BadRequestException;
