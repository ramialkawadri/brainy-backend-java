...
public class DefaultFileShareDao implements FileShareDao {
	...
	public List<SharedFile> getFilesSharedWithUser(User user) {
		...
		return entityManager.createQuery(query, SharedFile.class).setParameter("user", user)
				.getResultList();
	}
	...
	@Override
	@Transactional
	public void deleteFileShare(String fileOwnerUsername, String filename,
			String sharedWithUsername) {

		SharedFile sharedFile = getSharedFile(fileOwnerUsername, filename, sharedWithUsername);
	...
	@Override
	@Transactional
	public void updateSharedFileAccess(String fileOwnerUsername, String filename,
	...
	private SharedFile getSharedFile(String fileOwnerUsername, String filename,
			String sharedWithUsername) {
