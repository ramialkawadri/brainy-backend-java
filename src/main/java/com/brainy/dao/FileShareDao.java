...
public interface FileShareDao {
	...
	boolean isFileSharedWith(String fileOwnerUsername, String filename, String sharedWithUsername);

	void shareFile(String fileOwnerUsername, String filename, String sharedWithUsername,
			boolean canEdit) throws BadRequestException;

	void deleteFileShare(String fileOwnerUsername, String filename, String sharedWithUsername);
